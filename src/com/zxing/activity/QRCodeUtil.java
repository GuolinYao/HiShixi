...
public class QRCodeUtil {
	...
	public Bitmap createQRCode(final Context context,
			final ImageView qrcodeImageView, final int logo, final String url) {
		...
		new Thread(new Runnable() {
			@Override
			public void run() {
				boolean success = QRCodeUtil.createQRImage(url, ActivityUtils
						.dip2px(context, 180), ActivityUtils.dip2px(context,
						180), BitmapFactory.decodeResource(
						context.getResources(), logo), filePath);
	...
	public Bitmap createQRCode2(final Context context,
			final ImageView qrcodeImageView, final int logo, final String url) {
