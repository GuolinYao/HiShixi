...
import com.shixi.gaodun.model.utils.MainUtils;

import java.util.ArrayList;
import java.util.List;


public class FlowTextViewLayout extends ViewGroup {
	...
	public FlowTextViewLayout(Context context) {
		super(context);
	}
	...
	private void requestLayoutInner() {
		...
		MainUtils.runInMainThread(new Runnable() {
			@Override
			public void run() {
				requestLayout();
			}
