...
import com.shixi.gaodun.libpull.PullToRefreshSwipeListView;
 ...
 * 
 * @author ronger
 * @date:2015-12-22 下午3:37:24
 */
@SuppressLint("InflateParams")
public abstract class BaseSwipeListViewFragment<T> extends ParentFragment implements OnRefreshListener,
		OnItemClickListener, OnScrollListener {
	protected LinearLayout mLayoutViewGroup;// 父容器
	protected PullToRefreshSwipeListView mPullToRefreshListView;
	// protected ListView myListView;
	protected SwipeMenuListView myListView;
	// 每页的起始位置
	...
	public void initListView(View view) {
		mLayoutViewGroup = (LinearLayout) view.findViewById(R.id.swipe_layout_groupview);
		// 若此fragment有额外的标题，则需重新赋值
		mMainNoneDataLayout = (FrameLayout) view.findViewById(R.id.swipe_layout_nonedata);
		mPullToRefreshListView = (PullToRefreshSwipeListView) view.findViewById(R.id.base_pullrefresh_swipelistview);
		mLoadMoreLayout = LayoutInflater.from(mContext).inflate(R.layout.loadmore_layout, null);
	...
	public void setListPullShow() {
		...
		if (null != mPullToRefreshListView && mPullToRefreshListView.getVisibility() == View.GONE)
